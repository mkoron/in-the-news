"""
A news gathering program that gets news from NNTP server and scrapping news web pages.
...
Change the various _url, _title, _body, _server, _group and _howmany with your own values.
...
class NewsAgent:
    """
    Distribute news items from news sources to news
    destinations.
    """
